...
const Shorten = () => {
    ...
    return (
        <div className='bg-gradient-to-br from-indigo-900 via-purple-900 to-black min-h-[90.3vh] flex justify-center items-center px-4'>
            <div className='w-full max-w-2xl p-6 rounded-xl mt-10 bg-white/10 backdrop-blur-md border border-white/20 shadow-lg'>
                <div className='hover:scale-105 transition-all duration-200 ease-in-out hover:pb-1 text-center'>
                    <h1 className='font-extrabold text-2xl sm:text-3xl text-gray-300'>Generate Your Short</h1>
                    <h1 className='font-extrabold text-2xl sm:text-3xl text-gray-300'>URLs</h1>
                </div>
